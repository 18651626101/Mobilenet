...
*/
static int max_input = 0;
static int max_output = 0;
static int max_pad = 0;
...
void conv(const int input_depth, const int input_width, 
    ...
    double* input, double* output, double * buffer, const bool clip){
    ...
    // if(input_depth*in_width*in_width>max_pad)
    //     max_pad = input_depth*in_width*in_width;
    // if(input_depth*input_width*input_width>max_input)
    //     max_input = input_depth*input_width*input_width;
    // if(filter_num*out_width*out_width>max_output)
    //     max_output = filter_num*out_width*out_width;
    // printf("%d %d %d\n", max_input,max_output,max_pad);
